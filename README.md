...
In addition, if you have a different number of drives than the reference configuration, then you must update `NUM_CONTROLLERS` in [/filecoin_pc1/blob/main/src/sealing/constants.hpp](/filecoin_pc1/blob/main/src/sealing/constants.hpp)
